#!/usr/bin/env node
/**
 * Child process for `TaskDummyHarvest` (`runNodeTaskScript`) or standalone.
 *
 * Standalone: `npx tsx scripts/customTasks/dummy-harvest-worker.js --source=armls --resource=properties`
...
const flow = async (context) => {
    ...
    const photoUrls = [`https://example.com/photo/${source}/${resource}/1.jpg`];
